...
<head>
  ...
  <title>POES | Examination Instructions</title>
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
     ...
     <ul class="treeview-menu active">
            <li class="active"><a href="instruction.php"><i class="fa fa-circle"></i> Instructions</a></li>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Examination Instructions</li>
      </ol>
    </section>
...
<div class="callout callout-info">
    ...
    <ul>
	<li>The examination contain 20 questions</li>
	<li>Each question carries 5 marks</li>
	<li>You are required to answer all questions</li>
	<li>Passmark is 50%, below that you have failed the exam</li>
